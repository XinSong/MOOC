...
#######################
"""
In PART I, you will implement generic search algorithms which are called 
by Pacman agents (in PART II).
"""
...
#######################
"""
PART II contains all of the agents that can be selected to 
...
#       after you fill in parts of PART I             #
#######################################################
...
class SearchAgent(Agent):
  ...
  def __init__(self, fn='depthFirstSearch', prob='PositionSearchProblem', heuristic='nullHeuristic'):
    ...
    if 'heuristic' not in func.func_code.co_varnames:
      ...
      if heuristic in dir(self):
        heur = heuristic
      else:
        raise AttributeError, heuristic + ' is not a function in search.py.'
    ...
    if prob not in dir(self) or not prob.endswith('Problem'): 
      raise AttributeError, prob + ' is not a search problem type in search.py.'
